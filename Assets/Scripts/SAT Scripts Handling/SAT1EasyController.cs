...
namespace SAT1Controller
{
    ...
    {
        [Header("Car Settings (ARCADE RACER)")]
        public float acceleration = 4000f;
        public float arcadeBoostForce = 10000f; 
        public float maxSpeed = 55f; 
        public float turnSpeed = 4f;
        public float driftFactor = 0.95f;
        public float driftBoost = 1.1f;
        public float brakeForce = 9000f;
        public float gripStrength = 10f; 

        [Header("Impact Settings")]
        public float heavyStunDuration = 3.0f; 
        ...
        void HandleAcceleration()
        {
            if (isStunned)
            {
                ...
                // 🔥 THE FIX: Released the brakes! 
                // The car will now roll and coast forward instead of locking up.
        ...
        IEnumerator StunRoutine(float stunDuration)
        {
            ...
            // 🔥 THE FIX: Cuts speed by exactly 85% (leaving 15% momentum so you keep rolling)
